...
object ColorBox {
    ...
    val PRIMARY_COLOR_LIGHT = Color(0xFFF78D27)
    val SUCCESS_COLOR_LIGHT = Color(0xFF1b8553)
    val WARNING_COLOR_LIGHT = Color(0xFF9c6e03)
    val ERROR_COLOR_LIGHT = Color(0xFFc01c28)
    val WINDOW_COLOR_LIGHT = Color(0XFFfafafa)
    val CARD_COLOR_LIGHT = Color(0XFFEBEBEB)
    val CARD2_COLOR_LIGHT = Color(0XFFF0F0F0)
    val VIEW_COLOR_LIGHT = Color(0XFFd8d8d8)
    val TEXT_COLOR_LIGHT = Color(0xFF000000)

    val PRIMARY_COLOR_DARK = Color(0xFFF78D27)
    val SUCCESS_COLOR_DARK = Color(0xFF8ff0a4)
    val WARNING_COLOR_DARK = Color(0xFFf8e45c)
    val ERROR_COLOR_DARK = Color(0xFFff7b63)
    val WINDOW_COLOR_DARK = Color(0XFF242424)
    val CARD_COLOR_DARK = Color(0xFF363636)
    val CARD2_COLOR_DARK = Color(0XFF303030)
    val VIEW_COLOR_DARK = Color(0XFF424242)
    val TEXT_COLOR_DARK = Color(0XFFFFFFFF)
